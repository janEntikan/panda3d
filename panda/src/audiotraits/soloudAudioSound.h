 ...
 *
 * @file soloudAudioSound.h
 * @author jan Entikan
 */

#ifndef SOLOUDAUDIOSOUND_H
#define SOLOUDAUDIOSOUND_H
...
class EXPCL_SOLOUD_AUDIO SoLoudAudioSound : public AudioSound {
  friend class SoLoudAudioManager;
...
private:
  ...
  SoLoudAudioManager::SoundData *_sd;
  ...
  ALuint _source;
  PT(SoLoudAudioManager) _manager;
...
public:
  ...
  static void init_type() {
    ...
    register_type(_type_handle, "SoLoudAudioSound", AudioSound::get_class_type());
  }
...
#include "soloudAudioSound.I"

#endif /* __SOLOUDAUDIOSOUND_H__ */
